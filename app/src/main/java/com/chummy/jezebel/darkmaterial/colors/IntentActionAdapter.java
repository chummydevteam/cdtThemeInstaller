...
public class IntentActionAdapter extends RecyclerView.Adapter<IntentActionAdapter.ViewHolder> {

    private List<Theme> action;
    private int rowLayout;
    private Context mContext;

    public IntentActionAdapter(List<Theme> countries, int rowLayout, Context context) {
    ...
    public void onClick(final View view) {
        int itemPosition = this.getChildPosition(view);
